...
def main():
    ...
    if not args.fixpdb:
        ...
        pdb_fname = f"{sys_name}/{pdb_name}_fixed.pdb"
        save_pdb(fixed_receptor.topology, fixed_receptor.positions, pdb_fname)
    ...
    system, topology = prepare_system.run(protein=pdb_fname, variants=None, ligands=ligands)
