...
def cmd_lineparser():
    parser = argparse.ArgumentParser(description="Runs AutoPath simulation.",
                                     epilog="""
        REPORTING BUGS
    ...
    parser.add_argument('-l', '--lig', dest='lig', required=True,
                        action='store', help='ligand SDF file or path ligands directory')
